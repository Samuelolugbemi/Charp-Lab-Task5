...
namespace ShapesTest
{
    class Program
    {
        ...
        {
            Console.Write("Input the Shape you want to calculate the area of: ");
            ...
            if (name == "Rectangle")
            {
                ...
                Console.WriteLine($"The area of the rectangle of length: {length} and breadth: {breadth} is {rectangle.Area()}");
            }
            else if (name == "Triangle")
            {
                ...
                Console.WriteLine($"The area of the triangle of base: {tbase} and height: {height} is {triangle.Area()}");
            }
            else if (name == "Square")
            {
                name = "Square";
                ...
                Console.WriteLine($"The area of the square of length: {length} is {square.Area()}");
            }
            else if (name == "Cube")
            {
                name = "Cube";
                ...
                Console.WriteLine($"The area of the cube of length: {length} is {cube.Area()}");
            }
            else
            {
